...
export default defineConfig({
  ...
  shortcuts: [{
    'bg-base': 'bg-light-100 dark:bg-[#0f0f0f]',
    'bg-base-100': 'bg-light-200 dark:bg-[#0f0f0f]',
    'bg-blur': 'bg-light-200/85 dark:bg-[#0f0f0f]/85 backdrop-blur-xl backdrop-saturate-150',
    'bg-sidebar': 'bg-light-400 dark:bg-[#0f0f0f]',
